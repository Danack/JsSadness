...
<!--  <link href="/fonts/Jost-VariableFont_wght.ttf" rel="preload" as="font">-->
<!--  <link href="/fonts/RobotoFlex[slnt,wdth,wght,opsz].ttf" rel="preload" as="font">-->
</head>
...
function createPageHtml(
    ...
    $pageTitle = $page->getTitle() ?? "JS Sadness";

    $assetSuffix = \JsSadness\App::getAssetSuffix();
